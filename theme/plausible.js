...
// All data stays on your own server at /api/event
...
(function() {
  ...
  scriptEl.setAttribute('data-api', API_ENDPOINT);

  // Store original currentScript and temporarily override
  var originalScript = document.currentScript;
  Object.defineProperty(document, 'currentScript', {
    value: scriptEl,
    configurable: true
  });

  // Plausible Analytics Script (v2.1 - from plausible.io/js/script.js)
